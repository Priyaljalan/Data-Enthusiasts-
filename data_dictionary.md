Dataset 1: Alphabet Inc. Historical Stock Price Data (HistoricalData_GOOGLE.csv)

Date — Trading date associated with each stock market observation
Close Price — Final trading price of Alphabet Inc. stock for the trading day
Open Price — Opening stock price for Alphabet Inc. on the trading day
High — Highest stock price recorded during the trading day
Low — Lowest stock price recorded during the trading day
Volume — Total number of shares traded during the trading session

Dataset 2: US 10-Year Treasury Yield Data (HistoricalData_10YrTreasury.csv)

Date — Observation date associated with the Treasury Yield value
Treasury Yield — United States 10-Year Treasury Yield interest rate for the corresponding date

Derived Variables and Analytical Metrics
