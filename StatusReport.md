...
1. Get historic data on Alphabet (Google) and treasury rates - Completed

2. Clean and organize the datasets - Completed

3. Compute the standard deviation and volatility of the stock -

4. Calculate the percent of daily returns for the stock -

5. Perform the benchmark analysis for the stock - 

6. Calculate the risk-to-reward ratio for the stock -

7. Calculate Risk premium and correlation - 

8.  Create Visualizations to interpret the results - 

9. Write the final report and review it - 

Above are all the tasks that we need 

Here are our datasets: 

1) Alphabet (Google) - https://github.com/Priyaljalan/Data-Enthusiasts-/blob/main/HistoricalData_GOOGLE.csv
2) Treasury rates - https://github.com/Priyaljalan/Data-Enthusiasts-/blob/main/HistoricalData_10YrTreasury.csv
